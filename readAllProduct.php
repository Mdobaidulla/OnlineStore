...
<input type="button" class="mainPageButton1" onclick="location.href='#.html';" value="All Products" />
...
$sql = "SELECT id, productId,productName,size,price, sum(quantity) as quantity FROM productT group by productId,productName, size order by productId asc";
